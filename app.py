...
# Application du look Valorant par défaut
apply_global_styles()
...
if not st.session_state["logged_in"]:
    ...
    # ON GARDE TES COLONNES ICI POUR LE LOGIN
...
# --- 4. INTERFACE PRINCIPALE (SI CONNECTÉ) ---
    ...
    # On vérifie si on doit afficher Valoplant en plein écran
    ...
    if is_strat_page and has_map_selected:
        ...
        # --- MODE NAVIGATION NORMALE (HQ) ---
        st.markdown("<h1 class='valo-title'>CRIMSON HQ</h1>", unsafe_allow_html=True)
        
        # Menu horizontal avec tes colonnes d'origine
        ...
        # Routage vers les fonctions de logic.py sans rien oublier
